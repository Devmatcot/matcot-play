    ...
    if (isPlayerViewVisible) {
      return WillPopScope(
        onWillPop: () async {
          ...
          //       .showSnackBar(SnackBar(content: Text('Press Back To Exist/ Stop Player')));
                    ...
                    StreamBuilder<DurationState>(
                      ...
                      builder: (_, snapshot) {
                        ...
                        return Slider(
                            ...
                            activeColor: const Color.fromARGB(255, 6, 80, 141),
                            thumbColor: cblue,
        ...
        onWillPop: () async {
          if (_lastQuitTime == null ||
            ...
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text('Press The Back Button Again To Stop/Exit',textAlign: TextAlign.center),
              backgroundColor: Color.fromARGB(255, 146, 19, 9),
